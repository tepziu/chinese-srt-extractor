...
def upload_video():
    ...
    if action_mode == "clean_only":
        ...
        clean_hardsub = str(request.form.get("clean_hardsub", "true")).lower() == "true"
        clean_logo = str(request.form.get("clean_logo", "false")).lower() == "true"
        clean_title = str(request.form.get("clean_title", "false")).lower() == "true"
...
def upload_finish():
    ...
    if upload_type == "hardsub":
        ...
        if action_mode == "clean_only":
            ...
            clean_hardsub = bool(meta.get("clean_hardsub", True))
            clean_logo = bool(meta.get("clean_logo", False))
            clean_title = bool(meta.get("clean_title", False))
